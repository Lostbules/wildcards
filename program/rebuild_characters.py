...
SERIES = ['bishoujo_mangekyou', 'bocchi_the_rock', 'clannad', 'danmachi', 'dead_or_alive', 'demon_slayer', 'douluo_dalu', 'final_fantasy', 'genshin_impact', 'goblin_slayer', 'honkai_verse', 'kabaneri', 'kaguya_sama', 'konosuba', 'mushoku_tensei', 'naruto', 'oregairu', 'oreimo_eromanga', 're_zero', 'remaining_characters', 'rozen_maiden', 'seishun_buta', 'sono_bisque_doll', 'to_love_ru', 'toaru', 'touhou', 'trails_series', 'zero_no_tsukaima']
